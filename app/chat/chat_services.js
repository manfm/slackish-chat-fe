...
.factory('mySockets', ['userService', '$websocket', function(userService, $websocket) {
  ...
  function init() {
    ...
    ws = $websocket('ws://localhost:5000/websocket?uid=' + uid + '&access-token=' + accessToken + '&client=' + clientId);
    ws.onOpen(function() {
...
.factory('chatRoomService', ['userService', '$websocket', function(userService, $websocket) {
  var chatRooms = [];
  var service = {};
